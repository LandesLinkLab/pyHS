...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'a15_echem_p4_cv3'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS", "093025_AuAg_echem/a15_echem_p4_cv3")  # Output directory for EChem results
...
args['BRIGHT_INITIAL_GUESS'] = [570, 700, 750]  # Wavelengths in nm (REQUIRED, must be a list)
...
args['ECHEM_CYCLE_PLOT_END'] = 2      # Last cycle to display in detail plots
