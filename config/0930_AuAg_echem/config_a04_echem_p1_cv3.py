...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'a04_echem_p1_cv3'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS", "093025_AuAg_echem/a04_echem_p1_cv3")  # Output directory for EChem results
