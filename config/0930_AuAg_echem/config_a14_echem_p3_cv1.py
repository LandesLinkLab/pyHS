...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'a14_echem_p3_cv1'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS", "093025_AuAg_echem/a14_echem_p3_cv1")  # Output directory for EChem results
...
args['PEAK_INITIAL_GUESS'] = [580, 740]  # Initial guess for peak positions
...
args['PEAK_POSITION_TOLERANCE'] = [20, 30]  # Constrain peak positions during fitting
...
args['BRIGHT_INITIAL_GUESS'] = [580, 740]  # Wavelengths in nm (REQUIRED, must be a list)
                                            # Example: [690, 565] for two bright peaks
args['BRIGHT_POSITION_TOLERANCE'] = [20, 30]  # ±nm constraint for each bright peak
