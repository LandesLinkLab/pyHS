...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'a14_echem_p1_cv1'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS", "093025_AuAg_echem/a14_echem_p1_cv1")  # Output directory for EChem results
...
args['PEAK_INITIAL_GUESS'] = [570, 670, 760]  # Initial guess for peak positions
...
args['NUM_BRIGHT_MODES'] = 4  # Number of bright modes (non-interacting background)
args['BRIGHT_INITIAL_GUESS'] = [570, 660, 790, 910]  # Wavelengths in nm (REQUIRED, must be a list)
                                            # Example: [690, 565] for two bright peaks
args['BRIGHT_POSITION_TOLERANCE'] = [20, 20, 30, 50]  # ±nm constraint for each bright peak
