...
# ============================================================================
args['SAMPLE_NAME'] = 'AuNR_MB_PT'  # Name of the main TDMS file (without .tdms extension)
args['DATA_DIR'] = os.path.join(home, 'dataset/pyHS/Tathagata/MB_Monomer')  # Directory containing TDMS files
...
args['OUTPUT_DIR'] = os.path.join(home, "research/Tathagata/MB_Monomer")  # Output directory for DFS results
