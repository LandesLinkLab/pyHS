...
# ============================================================================
args['SAMPLE_NAME'] = 'AuAg_area_12_echem'  # Name of the main TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS/110525_AuAg/hyperspectral/area_12_echem")  
