...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'AuAg_area05_p2_cv'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS/110525_AuAg/echem/area05_p2")  # Output directory for EChem results
...
args['PEAK_HEIGHT_INITIAL_GUESS'] = [40, 40, 30]  # List of amplitudes (REQUIRED!)
