...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'AuAg_area10_p1_cv'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS/110525_AuAg/echem/area10_p1")  # Output directory for EChem results
...
args['PEAK_POSITION_INITIAL_GUESS'] = [580, 640, 785]  # List of positions in nm (REQUIRED!)
...
args['PEAK_HEIGHT_INITIAL_GUESS'] = [63, 3, 4]  # List of amplitudes (REQUIRED!)
                                            # Normalized (typically 0.1 - 1.0)
                                            # MUST match NUM_PEAKS

# Constraints
args['PEAK_WIDTH_MAX'] = [80, 100, 150]  # Max FWHM per peak
...
args['PEAK_MIN_DISTANCE'] = 40.0  # Minimum distance between peaks (nm)
