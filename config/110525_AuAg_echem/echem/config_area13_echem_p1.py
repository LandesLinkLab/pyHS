...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'AuAg_area13_p1_cv'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS/110525_AuAg/echem/area13_p1")  # Output directory for EChem results
