...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'AuAg_area14_p1_cv'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS/110525_AuAg/echem/area14_p1")  # Output directory for EChem results
...
args['PEAK_POSITION_INITIAL_GUESS'] = [550, 600, 800]  # List of positions in nm (REQUIRED!)
                                                # Example for 2 peaks: [600, 800]
                                                # MUST match NUM_PEAKS

args['PEAK_WIDTH_INITIAL_GUESS'] = [70, 70, 100]  # List of FWHMs in nm (REQUIRED!)
...
# Constraints
args['PEAK_WIDTH_MAX'] = [100, 70, 150]  # Max FWHM per peak
