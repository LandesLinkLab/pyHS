...
# ============================================================================
args['ECHEM_SAMPLE_NAME'] = 'AuAg_area08_p2_cv'  # Name of EChem spectral TDMS file (without .tdms extension)
...
args['OUTPUT_DIR'] = os.path.join(home, "research/pyHS/110525_AuAg/echem/area08_p2")  # Output directory for EChem results
...
args['PEAK_POSITION_INITIAL_GUESS'] = [580, 640, 830]  # List of positions in nm (REQUIRED!)
